...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    //2.pass managedObjectContext directly from AppDelegae to ViewController
//    ViewController *controller = (ViewController*)self.window.rootViewController;
//    //call function
//    [controller configureManagedObjectContext:self.managedObjectContext];
    [CoreDateManager shared];
...
- (void)saveContext {
        ...
        [[[CoreDateManager shared] managedObjectContext]save:&saveError];
        if(saveError){
            return;
        }
    }
